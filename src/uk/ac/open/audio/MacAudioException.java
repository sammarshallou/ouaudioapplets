...
/** Exception thrown when errors occur in the Mac audio system. */
public class MacAudioException extends AudioException
{
	/**
	 * @param message Exception text
	 */
	public MacAudioException(String message)
	{
		super(message);
	}
}
